...
public class ASMUtils {
    ...
    /**
     * Returns a MethodInsnNode INVOKEVIRTUAL instruction with the given owner, name,
     * and desc.
     * 
     * @param owner the owner of the method
     * @param name  the name of the method
     * @param desc  the descriptor of the method
     * @return a MethodInsnNode INVOKEVIRTUAL instruction with the given owner, name,
     *         and desc.
     */
